...
CREATE TABLE "RemediationJob" (
    ...
    "suggestedAlgorithm" TEXT,
    "status" TEXT NOT NULL DEFAULT 'PENDING',
    "agentModel" TEXT NOT NULL DEFAULT 'claude-sonnet-5',
    "agentReasoning" TEXT,
    "diffPatch" TEXT,
    "patchedContent" TEXT,
...
-- CreateIndex
CREATE INDEX "CryptoAsset_assetType_idx" ON "CryptoAsset"("assetType");

-- CreateIndex
CREATE INDEX "CryptoAsset_migrationStatus_idx" ON "CryptoAsset"("migrationStatus");

-- CreateIndex
CREATE UNIQUE INDEX "CryptoAsset_tenantId_assetFingerprint_key" ON "CryptoAsset"("tenantId", "assetFingerprint");
...
-- CreateIndex
CREATE UNIQUE INDEX "RemediationJob_ref_key" ON "RemediationJob"("ref");

-- CreateIndex
CREATE INDEX "RemediationJob_tenantId_idx" ON "RemediationJob"("tenantId");

-- CreateIndex
CREATE INDEX "RemediationJob_observationId_idx" ON "RemediationJob"("observationId");

-- CreateIndex
CREATE INDEX "RemediationJob_status_idx" ON "RemediationJob"("status");
...
-- AddForeignKey
ALTER TABLE "RemediationJob" ADD CONSTRAINT "RemediationJob_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "RemediationJob" ADD CONSTRAINT "RemediationJob_observationId_fkey" FOREIGN KEY ("observationId") REFERENCES "CryptoObservation"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "RemediationJob" ADD CONSTRAINT "RemediationJob_requestedById_fkey" FOREIGN KEY ("requestedById") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
